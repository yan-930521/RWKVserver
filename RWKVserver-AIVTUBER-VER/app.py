...
MODEL_PATH: str = "../model/RWKV-4-World-7B_CN-Q5_1.bin"
...
CACHE_NAME = "default_sakura_v4_with_emotion"
...
def load_model():
    ...
    model = RWKVModel(library, MODEL_PATH, CPU_COUNT)
...
print("Starting AI VTUBER Process", flush=True)
